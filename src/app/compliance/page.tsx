    ...
    <div>
      <div className="border-2">
        ...
        <div className="py-6">
          ...
          <div className="py-2">
            <p>
              株式会社Swappy（以下「弊社」と呼びます。）の基本方針として「すべての人に可能性を」と掲げ、弊社が行う事業を通じ、新しい価値を持続的に社会に届けることを目的としております。
            </p>
          </div>
        </div>
        <div className="py-6">
          <h3 className="text-lg font-bold">第２条 （社会的責任）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第３条 （法令遵守）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第４条 （公正な取引）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第５条 （個人情報の保護）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第６条 （情報開示）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第７条 （社員の尊重）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第８条 （反社会的勢力の排除）</h3>
          <div className="py-2">
            <p>
        ...
        <div className="py-6">
          <h3 className="text-lg font-bold">第９条 （贈答・接待の受領）</h3>
          <div className="py-2">
            <p>
