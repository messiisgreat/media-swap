        ...
        <Section>
          ...
          <div className="py-6">
            ...
            <ul>
              ...
              <li>
                (19)
                当社または第三者の広告を顧客に合わせて配信または表示する目的
              </li>
              <li>
                (20)
              ...
              <li>
                (22)
                サービスに関する不正利用の防止およびセキュリティの確保の目的
              </li>
            </ul>
          </div>
          ...
          <div className="py-6">
            <p>
              弊社は「プライバシーポリシー」に関し、適宜改善に取り組みます。
            </p>
