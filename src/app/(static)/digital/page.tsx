    ...
    <div>
      <div className="border-2">
        ...
        <Section className="py-6">
          <H className="text-lg font-bold">第 1 条 書面の電磁的交付について</H>
        ...
        <Section className="py-6">
          ...
          <Section className="py-2">
            <p>
              書面を電磁的手段で提供する方法として、{SITE_NAME}
              アプリの画面でユーザーが確認できる形で表示します。ユーザーは、表示された画面をスマートフォンやPCへ保存するため、スクリーンショットなどを取ってください。その際の保存形式は、jpgまたはpngを推奨します。
            </p>
          </Section>
        </Section>
        <Section className="py-6">
          <H className="text-lg font-bold">第 3 条 通信費用等</H>
          <Section className="py-2">
            <p>
        ...
        <Section className="py-6">
          <H className="text-lg font-bold">第 4 条 電磁的方法の変更</H>
          <Section className="py-2">
            <p>
              弊社は、電磁的方法による書面の提供について、利用者への影響が非常に小さいと考えられる場合、
              {SITE_NAME}
              アプリでの告知や弊社のウェブサイトへの情報掲載などを通じて内容をお知らせします。このような場合、第2条に記載された電磁的方法の変更を、ユーザーの追加の同意なしに行うことが可能となります。
            </p>
          </Section>
        </Section>
        <Section className="py-6">
          <H className="text-lg font-bold">第 5 条 郵送による交付</H>
          <Section className="py-2">
            <p>
