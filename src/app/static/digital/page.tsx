    ...
    <div>
      <div className="border-2">
        ...
        <div className="py-6">
          ...
          <div className="py-2">
            <p>
              書面を電磁的手段で提供する方法として、Swappyアプリの画面でユーザーが確認できる形で表示します。ユーザーは、表示された画面をスマートフォンやPCへ保存するため、スクリーンショットなどを取ってください。その際の保存形式は、jpgまたはpngを推奨します。
            </p>
          </div>
        </div>
        <div className="py-6">
        ...
        <div className="py-6">
          ...
          <div className="py-2">
            <p>
              弊社は、電磁的方法による書面の提供について、利用者への影響が非常に小さいと考えられる場合、Swappyアプリでの告知や弊社のウェブサイトへの情報掲載などを通じて内容をお知らせします。このような場合、第2条に記載された電磁的方法の変更を、ユーザーの追加の同意なしに行うことが可能となります。
            </p>
          </div>
        </div>
        <div className="py-6">
