...
export const DELIVERY_SERVICE_PROVIDER_URLS = {
  JAPAN_POST: "https://www.post.japanpost.jp/receive/tracking/",
  YAMATO_TRANSPORT: "https://toi.kuronekoyamato.co.jp/cgi-bin/tneko",
} as const;

export const SHIPPING_METHOD_DELIVERY_SERVICE_PROVIDER_URLS = {
  1: DELIVERY_SERVICE_PROVIDER_URLS.JAPAN_POST,
  2: DELIVERY_SERVICE_PROVIDER_URLS.JAPAN_POST,
  3: DELIVERY_SERVICE_PROVIDER_URLS.JAPAN_POST,
  4: DELIVERY_SERVICE_PROVIDER_URLS.YAMATO_TRANSPORT,
  5: DELIVERY_SERVICE_PROVIDER_URLS.JAPAN_POST,
